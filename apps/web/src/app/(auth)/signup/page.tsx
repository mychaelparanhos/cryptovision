    ...
    <div className="flex min-h-screen items-center justify-center bg-[#09090B] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-[#27272A] bg-[#18181B] p-8">
          <h1 className="mb-1 text-2xl font-bold text-[#FAFAFA]">Create your account</h1>
          <p className="mb-6 text-sm text-[#A1A1AA]">
            Start tracking crypto futures for free
          </p>

          {ref && (
            <div className="mb-4 rounded-lg border border-[#F59E0B]/20 bg-[#F59E0B]/10 px-4 py-3 text-sm text-[#F59E0B]">
              You were referred by a friend! Your referral has been captured.
            </div>
          )}
          ...
          <button
            ...
            className="mb-4 flex w-full items-center justify-center gap-3 rounded-lg border border-[#27272A] bg-[#09090B] px-4 py-3 text-sm font-medium text-[#FAFAFA] transition-colors hover:border-[#3F3F46] hover:bg-[#27272A]"
          >
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#18181B] px-3 text-[#71717A]">or</span>
            </div>
          </div>
